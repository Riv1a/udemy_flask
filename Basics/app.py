...
@app.route('/home', methods=['POST', 'GET'], defaults={'name' : 'Sir or Madam'})
...
def process():
    ...
    return '<h1>Hello {}. You are from {}. You have submitted the form sucessfully!</h1>'.format(name, location)
'''
